...
var libc = Process.getModuleByName("libFridaEight.so")
var strcmp_addr = libc.enumerateImports()[4]["address"]
//var strcmp_addr = Process.findModuleByName("libc.so", "strcmp")
Interceptor.attach(strcmp_addr, {
    onEnter: function (args) {
        var arg0Address = args[0];
        var arg0String = arg0Address.readUtf8String();
        var arg1Address = args[1];
        var arg1String = arg1Address.readUtf8String();
        if (arg0String.includes("Hello")) {
            console.log("Hooking the strcmp function")
            console.log("flag is ", + arg1String)
        }
    },
